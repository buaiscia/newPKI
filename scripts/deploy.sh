...
#exec 1>/var/www/html/PKI/depl_log.txt 2>&1
...
function action_few {
        ...
        #echo "Choose the FEW file to deploy"

        #select filename in /home/appsupp/HCUS-MIDDLEWARE-FEW*
        #do
...
function action_api {
 ...
 #echo "Choose the API file to deploy"

       # select filename in /home/appsupp/HCUS-MIDDLEWARE-API*
       # do
...
function action_admin {
       ...
       # echo "Choose the ADMIN file to deploy"

       # select filename in /home/appsupp/HCUS-MIDDLEWARE-ADMIN*
       # do
